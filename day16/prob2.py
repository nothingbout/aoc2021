...
def evaluate_packet(packet):
    sub_values = [evaluate_packet(sub) for sub in packet.sub_packets]

    match packet.type_id:
        case 0: return sum(sub_values)
        case 1: return reduce(lambda x, y: x * y, sub_values)
        case 2: return min(sub_values)
        case 3: return max(sub_values)
        case 4: return packet.literal_value
        case 5: return 1 if sub_values[0] > sub_values[1] else 0
        case 6: return 1 if sub_values[0] < sub_values[1] else 0
        case 7: return 1 if sub_values[0] == sub_values[1] else 0
...
for line in lines:
    ...
    print(f'{line}: {evaluate_packet(root_packet)}')
